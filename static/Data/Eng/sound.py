...
label.pack(pady=100)
button_next = ttk.Button(window, text="Next", command=next_sentence, style="BW.TButton")
button_next.pack(pady=10)
button_record = ttk.Button(window, text="Record voice (5 seconds)", command=record_voice, style="BW.TButton")
button_record.pack(pady=10)
button_play = ttk.Button(window, text="Listen to the voice", command=play_audio, style="BW.TButton")
